...
from chromadb.errors import InvalidDimensionException, InvalidCollectionException, CollectionNotFoundError
...
class SegmentAPI(API):
    ...
    def _modify(
        ...
        if existing:
            ...
            raise CollectionNotFoundError(f"Collection with id {id} does not exist.")
